...
## 9. Тестирование mock_api

Для автоматизированного тестирования API созданы bat-скрипты, которые используют тестовые данные из `seed_demo_data.py`.
...
```cmd
test_admin.bat      # тесты администратора
test_editor.bat     # тесты редактора
test_viewer.bat     # тесты наблюдателя
test_inactive.bat   # тест неактивного пользователя
